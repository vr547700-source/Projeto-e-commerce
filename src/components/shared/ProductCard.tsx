...
const ProductCard = ({ product, onAddToCart }: ProductCardProps) => {
  ...
  return (
    <article className="group flex flex-col rounded-2xl border border-slate-200 bg-white transition-shadow hover:shadow-md dark:border-slate-800 dark:bg-slate-900">
      <div className="relative overflow-hidden rounded-t-2xl bg-slate-50 dark:bg-slate-800">
        ...
        <button
          ...
          className="absolute right-2 top-2 rounded-full bg-white/80 p-1.5 shadow transition-colors hover:bg-white dark:bg-slate-900/80 dark:hover:bg-slate-900"
        >
          {wishlisted ? (
